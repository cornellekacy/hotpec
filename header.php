...
<!-- Page Title -->
<title>Hotpec Orphanage | Home</title>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-8724347165973322",
...
<div id="side-panel" class="dark" data-bg-img="images/bg/bg8.jpg">
  <div class="side-panel-wrap">
    ...
    <a href="javascript:void(0)"><img alt="logo" src="logo-wide1.png"></a>
      ...
      <div class="widget no-border">
        <nav>
          <ul class="nav nav-list">
            ...
            <li><a href="what.php">Activities</a></li>
    ...
    <div class="side-panel-widget mt-30">
      <div class="widget no-border">
        <ul>
          <li class="font-14 mb-5"> <i class="fa fa-phone text-theme-colored"></i> <a href="#" class="text-gray">+237 677201621</a> </li>
          <li class="font-14 mb-5"> <i class="fa fa-phone text-theme-colored"></i> <a href="#" class="text-gray">+237 675082258</a> </li>
          <li class="font-14 mb-5"> <i class="fa fa-clock-o text-theme-colored"></i> Mon-Fri 8:00 to 2:00 </li>
          <li class="font-14 mb-5"> <i class="fa fa-envelope-o text-theme-colored"></i> <a href="#" class="text-gray">hotpec2.zad@gmail.com</a> </li>
        </ul>      
      </div>
      <div class="widget">
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0">
              <a class="menuzord-brand xs-pull-center mb-15" href="javascript:void(0)"><img src="logo-wide1.png" alt=""></a>
            </div>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="widget no-border m-0">
              <div class="mt-10 mb-10 text-right sm-text-center">
                <div class="font-20 text-black-333 text-uppercase mb-5 font-weight-600"><i class="fa fa-phone-square text-theme-colored font-24"></i> +237 677201621</div>
          ...
          <div class="col-xs-12 col-sm-4 col-md-3">
            <div class="widget no-border m-0">
              <div class="mt-10 mb-10 text-right sm-text-center">
                ...
                <a class="font-12 text-gray" href="#"> hotpec2.zad@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed bg-light">
        ...
        <li class="active"><a href="index.php">Home</a> </li>
            <li><a href="about.php">About Us</a></li>
             <li><a href="whatwedo.php">Activities</a></li>
            <li><a href="gallery.php">Gallery</a></li>
            <li><a href="project.php">Projects</a></li>
