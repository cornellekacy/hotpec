    ...
    <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.2"  data-bg-img="images/bg/bg2.jpg">
      <div class="container">
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mt-0">Agricultural Unit Hotpec Orphanage</h2>
      ...
      <div class="col-md-8">
        <h4>HOTPEC Orphanage is involved in agriculture in the following sections <br>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">Agricultural Unit Gallery</h3>
