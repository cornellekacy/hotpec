    ...
    <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.2"  data-bg-img="images/bg/bg2.jpg">
      <div class="container">
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mt-0">Hotpec Orphanage Projects</h2>
      ...
      <div class="col-md-8">
        <h4>The volunteers are people who come from other countries and even from within to help give care and support to enable the children and management have a better life.
The paid workers are those who have to give in some skills for monthly salary.
    ...
    <br><hr>
      ...
      <div class="container pb-80">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">On Going Projects</h3>
              <div class="title-icon">
                <i class="flaticon-charity-hand-holding-a-heart"></i>
              </div>
        ...
        <div class="row mtli-row-clearfix">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Vocational Collage</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
    ...
    <section> 
        ...
        <div class="row mtli-row-clearfix">
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Fishpond Project</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Development of farm land</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
      ...
      <div class="container pb-80">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">Projects Envisaged</h3>
              <div class="title-icon">
                <i class="flaticon-charity-hand-holding-a-heart"></i>
              </div>
        ...
        <div class="row mtli-row-clearfix">
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Playing ground for children</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Renovation of entire environment</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Income generating project</a></h5>
                <p></p>
                <ul class="list-inline clearfix mt-20">
