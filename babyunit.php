<?php include 'header.php'; ?>
    <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.2"  data-bg-img="images/bg/bg2.jpg">
      <div class="container">
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mt-0">Babys Unit Hotpec Orphanage</h2>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <h4>This a department where the orphanage take care of younger babies from 0-5 years old. This department has special workers eg. House mother, general caregiver who is in charge of cooking, cleaning etc. These workers are paid on monthly basis.</h4>
      </div>
      <div class="col-md-2">
      </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">Baby Unit Gallery</h3>
